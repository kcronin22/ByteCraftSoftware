  ...
  return (
    <Section id="about" eyebrow="Who we are" title="Small team, big builds.">
      <p>
        ...
        <strong>web applications</strong>, and <strong>APIs</strong>. We&apos;re
        obsessed with clear architecture, clean code, and shipping things that
        are actually maintainable six months from now.
      </p>
      <p>
